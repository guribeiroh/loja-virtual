...
export default function BookDetailClient({ book, bookId }: BookDetailClientProps) {
    ...
    return (
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-grow container mx-auto px-4 py-8 flex flex-col items-center justify-center">
          <p className="text-xl text-red-500 mb-4">Livro não encontrado</p>
          <a href="/" className="bg-orange-600 text-white py-2 px-4 rounded-md hover:bg-orange-700 transition-colors">
            Voltar para a loja
          </a>
        </main>
      </div>
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <div className="mb-6">
          <a href="/" className="text-orange-600 hover:underline flex items-center gap-1">
