  ...
  return (
    <div className="relative">
      <button 
        ...
        className="flex items-center gap-1 bg-orange-600 text-white py-2 px-4 rounded-full hover:bg-orange-700 transition-colors"
      >
                      ...
                      <div className="flex items-center justify-between mt-1">
                        <div className="flex items-center gap-1">
                          <button 
                            ...
                            className="text-gray-500 hover:text-orange-600 bg-gray-100 h-5 w-5 flex items-center justify-center rounded"
                          >
                            -
                          </button>
